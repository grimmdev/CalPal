...
<div align="center">
  <img src="https://via.placeholder.com/800x450?text=Dashboard+View" alt="Dashboard View" width="48%">
  <img src="https://via.placeholder.com/800x450?text=Public+Booking+Page" alt="Public Booking Page" width="48%">
</div>
